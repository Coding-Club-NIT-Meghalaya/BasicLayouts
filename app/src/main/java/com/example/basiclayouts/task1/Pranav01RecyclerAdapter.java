...
public class Pranav01RecyclerAdapter extends RecyclerView.Adapter<com.example.basiclayouts.task1.Pranav01RecyclerAdapter.MyViewHolder>{
    List<String> names;
    ...
    public Pranav01RecyclerAdapter(Context context, List<String> names, List<String> messages, List<String> profile, List<String> times, List<String> messageNum) {
        this.names = names;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.pranav01row_items,parent,false);
